...
cuz it describes actions that need to be done with the element depending on its type.
...
and actions on this element(function) as its 'value' */
 ...
 /* "actionsType[typeof point](point)"  is a function which firstly takes point's type ("actionsType[typeof point]") 
 and then returns a function depending on the type of this point, taking point as an argument */
